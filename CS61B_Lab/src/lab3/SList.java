...
//        }
    ...
    // codes from lecture 11: aim to test the equals() method
    @Override
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nConstruct a list: [ 6, 9, 12 ]");
        SList sl1 = new SList();
        sl1.insertFront(12);
        sl1.insertFront(9);
        sl1.insertFront(6);
        System.out.println("The list is: " + sl1.toString());

        System.out.println("\nChange the list to : [ 3, 6, 9, 12, 15 ]");
        sl1.insertFront(3);
        sl1.insertEnd(15);
        System.out.println("The current list is: " + sl1.toString());

        testEmpty();
        testAfterInsertFront();
        testAfterInsertEnd();

        testOfOverrideEquals();
    }
    ...
    /**
     *  test of overrided equals() method in lecture 11
     */
    private static void testOfOverrideEquals() {
        SList lst1 = new SList();
        lst1.insertFront(3);
        lst1.insertFront(2);
        lst1.insertFront(1);
        ...
        System.out.println("lst1 is: " + lst1.toString());
        System.out.println("lst2 is: " + lst2.toString());
        System.out.println("They should be equal by using Overrided equals() method, should be true: " + lst1.equals(lst2));
    }
}
