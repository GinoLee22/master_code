...
class Names {
    ...
    public static void main(String arg[]) {
        ...
        System.out.println();                                                         // 1st compile-time error: without ";"
        System.out.println(first + " " + middle + " " + last + " ");
        System.out.println(initials);
        System.out.println(last + ", " + first + " " + middle);
        System.out.println(last + ", " + first + " " + middleInit + ".");
        System.out.println(first.toUpperCase() + " " + last.toUpperCase());           // 2nd compile-time error: without "()"
        ...
        System.out.println("The character at index 3 in " + middle + " is " +
                middle.substring(3, 4));                                                // 1st run-time error
