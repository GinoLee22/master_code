...
public class DListNode extends ListNode {
     ...
     * @throws InvalidNodeException if this node is not valid.
     *                              <p>
     *                              Performance:  runs in O(1) time.
     */
    ...
    public void insertAfter(Object item) throws InvalidNodeException {
        ...
        //   new node.
        next = new DListNode(item, (DList) myList, this, next);
//        next = ((DList) myList).newNode(item, (DList) myList, this, next);
    ...
    public void insertBefore(Object item) throws InvalidNodeException {
        ...
        //   what DList it's in.  You should use myList.newNode() to create the
        //   new node.
        prev = new DListNode(item, (DList) myList, prev, this);
//        prev = ((DList) myList).newNode(item, (DList) myList, this, next);
        prev.prev.next = prev;
        myList.size++;
    }
