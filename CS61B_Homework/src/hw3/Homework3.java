...
public class Homework3 {
    ...
    public static void smoosh(int[] ints) {
        ...
        int i = 0;                      // the index of the final ints[]
        ...
        // assigning -1 to remaining elements in ints[]
        for (int index = (i + 1); index < ints.length; index++) {
            ints[index] = -1;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        SList selfList1 = new SList();              // list with 0 element
        selfList1.squish();
        System.out.println(selfList1.toString());

        SList selfList2 = new SList();              // list with 1 element
        selfList2.insertFront(1);
        selfList2.squish();
        System.out.println(selfList2.toString());
