...
public class SList {
    ...
    public void squish() {
        ...
        SListNode startNode = head;
        while (startNode != null && startNode.next != null) {   // there is only one or zero item in the list. Note: the condition should be in order !!!!
            if (startNode.item.equals(startNode.next.item)) {   // the previous one equals to the next one
    ...
    public void twin() {
        ...
        while (startNode != null) {
            startNode.next = new SListNode(startNode.item, startNode.next);
            size++;
